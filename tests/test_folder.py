...
def folder(mock_imap: AsyncMock, mock_smtp: AsyncMock) -> Folder:
    ...
    """
    return Folder(imap=mock_imap, smtp=mock_smtp, name="INBOX", default_from="test@example.com")
...
def test_folder_initialization(mock_imap: AsyncMock, mock_smtp: AsyncMock) -> None:
    ...
    folder = Folder(imap=mock_imap, smtp=mock_smtp, name="INBOX", default_from="test@example.com")
